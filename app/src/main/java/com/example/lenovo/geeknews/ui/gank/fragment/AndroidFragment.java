 ...
 */
public class AndroidFragment extends BaseFragment implements GankView {
...
//        img = inflate.findViewById(R.id.img);
    ...
    public void getTechList(GankItemBean gankItemBean) {
        final List<GankItemBean.ResultsBean> results = gankItemBean.getResults();
        list.addAll(results);
        ...
        gankAdapter.OnClick(new GankAdapter.OnItemClick() {
            ...
            public void OnItem(int pos) {
                ...
                intent.putExtra("url",results.get(pos).getUrl());
                intent.putExtra("title",results.get(pos).getDesc());
